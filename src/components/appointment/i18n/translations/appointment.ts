...
export const appointmentTranslations: Record<string, AppointmentTranslations> = {
  en: {
    ...
    form: {
      ...
      name: "Full Name",
      phone: "Phone Number",
      phoneInfo: "Enter your 10-digit number to auto-fill your details if you've visited before",
      age: "Age",
      city: "City",
      ...
      returningPatientInfo: "Your information has been loaded from our records.",
      newPatient: "New Patient",
      newPatientInfo: "Please enter your details to book an appointment.",
      days: {
        sunday: "Sunday",
        monday: "Monday",
        tuesday: "Tuesday",
  ...
  gu: {
    ...
    form: {
      ...
      name: "પૂરું નામ",
      phone: "ફોન નંબર",
      phoneInfo: "તમે આગળથી આવ્યા હોય તો તમારી વિગતોને આમલી કરવા માટે તમારી 10 અંકની સંખ્યા દાખલ કરો",
      age: "ઉંમર",
      city: "શહેર",
      ...
      returningPatient: "પાછળથી આવનારું દર્દીની",
      returningPatientInfo: "તમારી વિગતો અમારી રેકોર્ડ્સમાંથી આમલી થઈ છે.",
      newPatient: "નવું દર્દીની",
      newPatientInfo: "એપોઈન્ટમેન્ટ બુક કરવા માટે તમારી વિગતો દાખલ કરો.",
      days: {
        sunday: "રવિવાર",
        monday: "સોમવાર",
        tuesday: "મંગળવાર",
